...
import org.excitinglab.bronze.config.impl.ConfigImpl;
import org.excitinglab.bronze.config.impl.Parseable;
...
public final class ConfigFactory {
     ...
     * {@link System#getProperties()}, parsed and converted as with
     ...
     * {@link System#getenv(String)} though, since you can use methods
    ...
    /**
     * Converts a Java {@link Properties} object to a
     ...
     * {@link ClassLoader#getResources} must be called separately for
     ...
     * @param resourceBasename
     *            a resource name as in {@link Class#getResource},
     ...
     *
     * <p>
     * This works like {@link ClassLoader#getResource}, not like
     * {@link Class#getResource}, so the name never begins with a
     * slash.
     *
     * <p>
     ...
     *            {@link ClassLoader#getResource}, with or without
     *            extension
     * @param options
    ...
    /**
     * Creates a {@code Config} based on a {@link Map} from paths to
